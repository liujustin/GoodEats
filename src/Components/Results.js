...
const Results = props => {
  ...
  return (
    <>
      ...
      <Container>
        <Typography variant="h3" style={{ margin: "50px 100px" }}>
          {businessName}
        </Typography>
        <Typography variant="h5" style={{ margin: "0 100px" }}>
          {businessAddress}
        </Typography>
        <Typography variant="body1" style={{ margin: "0 100px" }}>
      ...
      <Typography variant="h4" style={{ margin: "0 130px" }}>
        Reviews
      </Typography>
